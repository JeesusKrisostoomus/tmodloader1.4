...
if test -z "${TMOD_AUTODOWNLOAD}" ; then
    ...
    /usr/lib/games/steam/steamcmd.sh +force_install_dir /data/steamMods +login anonymous +workshop_download_item 1281930 `echo -e $TMOD_AUTODOWNLOAD | sed 's/,/ +workshop_download_item 1281930 /g'` +quit
